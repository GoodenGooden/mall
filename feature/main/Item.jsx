...
function handleCart() {
  ...
  <div>
     ...
     <div className="flex justify-around bg-slate-900">
         ...
         <div className="text-white"> <Plus id={id} handleShopped={handleShopped} /> </div>
         
     </div>
     <div className=" text-center text-slate-900 mt-1">{title} </div>
     <div className=" text-center text-slate-900">#{price} </div>
